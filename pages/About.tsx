...
import { Users, Shield, Clock, MapPin, Award, Star, ArrowRight } from 'lucide-react';
...
export const About: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      {/* Modern Hero Section with Vibrant Gradient */}
      <div className="relative py-24 lg:py-32 bg-gradient-to-br from-brand-yellow via-amber-400 to-orange-500 overflow-hidden">
        {/* Abstract shapes for texture and depth */}
        <div className="absolute top-0 right-0 -mr-16 -mt-16 w-96 h-96 bg-white/20 rounded-full blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-80 h-80 bg-orange-600/30 rounded-full blur-3xl"></div>
        ...
        <div className="relative container mx-auto px-4 text-center z-10">
          ...
          <p className="text-base md:text-xl text-slate-900/80 max-w-2xl mx-auto leading-relaxed font-semibold px-4">
             Coimbatore-la irundhu enga venalum — We Take You There with trust and reliability.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center mb-32">
          <div className="space-y-8 order-2 lg:order-1">
            <div className="inline-flex items-center gap-2 text-brand-yellow font-bold text-[10px] uppercase tracking-[0.2em]">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 pt-6">
              <div className="p-6 sm:p-8 bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:shadow-lg transition-all group">
                <div className="w-10 h-10 bg-brand-yellow/10 rounded-xl flex items-center justify-center text-brand-yellow mb-4 group-hover:scale-110 transition-transform">
                  <Award size={24} />
                </div>
              ...
              <div className="p-6 sm:p-8 bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 hover:shadow-lg transition-all group">
                ...
                <span className="block text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white mb-2">50k+</span>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 order-1 lg:order-2">
             <div className="space-y-3 sm:space-y-4 mt-8 sm:mt-12">
               ...
               />
               <div className="bg-brand-yellow aspect-[2/1] rounded-2xl flex items-center justify-center text-slate-950 shadow-lg shadow-brand-yellow/20 transform hover:-translate-y-1 transition-transform p-4">
             ...
             <div className="space-y-3 sm:space-y-4">
               <div className="bg-slate-900 dark:bg-brand-yellow aspect-[2/1] rounded-2xl flex items-center justify-center text-white dark:text-slate-950 shadow-lg transform hover:-translate-y-1 transition-transform p-4">
                  <div className="text-center">
        ...
        <div className="mt-32 text-center bg-slate-900 dark:bg-white rounded-[3rem] p-12 md:p-24 overflow-hidden relative">
          ...
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-brand-yellow/10 rounded-full blur-3xl -ml-32 -mb-32"></div>
          
          <div className="relative z-10 space-y-8">
            <h2 className="text-4xl md:text-6xl font-black text-white dark:text-slate-950 uppercase tracking-tight leading-none">
              Ready for a <br/>
              <span className="text-brand-yellow">Better Ride?</span>
            </h2>
            ...
            <button 
              ...
              className="px-12 py-5 bg-brand-yellow text-slate-950 font-black rounded-2xl transition-all shadow-xl shadow-brand-yellow/20 hover:scale-105 active:scale-95 uppercase tracking-widest text-xs flex items-center gap-3 mx-auto"
            >
