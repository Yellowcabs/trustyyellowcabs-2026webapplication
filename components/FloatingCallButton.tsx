...
export const FloatingCallButton: React.FC = () => {
  return (
    ...
    >
      {/* Radar Signal Pulses */}
      <div className="absolute inset-0 border-2 border-brand-yellow rounded-full animate-radar-signal"></div>
      <div className="absolute inset-0 border-2 border-brand-yellow rounded-full animate-radar-signal [animation-delay:1.5s]"></div>
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative animate-ring-vibrate">
          ...
          {/* Main Button Container - Compact Glass Design */}
          <div className="bg-gradient-to-br from-yellow-400 via-brand-yellow to-amber-600 p-3.5 md:p-4 rounded-2xl shadow-xl border-t border-white/40 transform transition-all duration-500 group-hover:scale-110 group-active:scale-90 flex items-center justify-center relative overflow-hidden animate-glow-flow">
            ...
            <div className="animate-rhythmic-vibrate">
              <Phone size={20} strokeWidth={2.5} className="text-slate-950 drop-shadow-md" />
            </div>
          ...
          <div className="hidden md:block absolute right-full top-1/2 -translate-y-1/2 mr-4 pointer-events-none opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-4 group-hover:translate-x-0">
            <div className="bg-slate-950 dark:bg-white text-white dark:text-slate-950 px-3 py-2 rounded-xl shadow-2xl flex flex-col border border-white/10 whitespace-nowrap">
              <span className="text-[10px] font-black leading-none">+91 88700 88020</span>
              <span className="text-[7px] font-bold text-brand-yellow uppercase mt-0.5">Quick Booking</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-8 h-1 bg-slate-950/20 dark:bg-brand-yellow/10 blur-md rounded-full mt-4 transition-all duration-500 group-hover:scale-150 group-hover:opacity-30"></div>
    </a>
  );
};